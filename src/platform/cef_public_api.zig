...
pub const loadNSImageFromFile = cef_objc.loadNSImageFromFile;
...
pub const fireBeforeQuit = cef_message_loop.fireBeforeQuit;
...
pub const setMacContentMinSize = cef_mac_window.setMacContentMinSize;
pub const setMacContentMaxSize = cef_mac_window.setMacContentMaxSize;
pub const setMacStyleMaskBit = cef_mac_window.setMacStyleMaskBit;
pub const setMacZoomButtonEnabled = cef_mac_window.setMacZoomButtonEnabled;
pub const setMacMovable = cef_mac_window.setMacMovable;
pub const setMacIgnoresMouseEvents = cef_mac_window.setMacIgnoresMouseEvents;
pub const setMacCollectionBehaviorBit = cef_mac_window.setMacCollectionBehaviorBit;
pub const setMacWindowSharingType = cef_mac_window.setMacWindowSharingType;
...
pub const appFlashFrame = cef_app.appFlashFrame;
pub const appSetAboutPanelOptions = cef_app.appSetAboutPanelOptions;
pub const appShowAboutPanel = cef_app.appShowAboutPanel;
...
pub const DownloadEmitFn = cef_download_handler.DownloadEmitFn;
...
pub const MenuLifecycleEmitHandler = cef_menu.MenuLifecycleEmitHandler;
pub const setMenuLifecycleEmitHandler = cef_menu.setMenuLifecycleEmitHandler;
