...
pub const vtable: window_mod.Native.VTable = .{
    ...
    .stop = cef_web_contents.stopLoad,
    .insert_css = cef_web_contents.insertCss,
    .remove_inserted_css = cef_web_contents.removeInsertedCss,
    ...
    .set_content_protection = cef_window_runtime.setContentProtectionImpl,
    .is_content_protected = cef_window_runtime.isContentProtectedImpl,
    .set_skip_taskbar = cef_window_runtime.setSkipTaskbarImpl,
