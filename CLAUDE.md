...
// await autoUpdater.downloadArtifact(update, "/tmp/app.zip") / verifyFile(path, sha256)
// await autoUpdater.quitAndInstall(downloaded, {relaunch:true})            (macOS/Linux helper)
...
// await autoUpdater.downloadArtifact("https://example/app.zip", "/tmp/app.zip", {sha256})
// await autoUpdater.quitAndInstall(downloaded, {relaunch:true})            (macOS/Linux helper)
