#!/usr/bin/env bash
# Shell openPath runtime E2E — Linux GIO MIME handler round-trip.

set -euo pipefail

ROOT="$(cd "$(dirname "$0")/../.." && pwd)"
SUJI_LOG="${SUJI_LOG:-/tmp/suji-e2e-shell-open-path-runtime.log}"
...
e2e_run_test tests/e2e/shell-open-path-runtime.test.ts
