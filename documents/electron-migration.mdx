...
|---|---|
| `dialog.*` | [`dialog.mdx`](./dialog.mdx) |
| `clipboard.*`, `shell.*` | [`clipboard-shell.mdx`](./clipboard-shell.mdx) |
| `Tray` | [`tray.mdx`](./tray.mdx) |
| `Menu` | [`menu.mdx`](./menu.mdx) |
| `Notification` | [`notification.mdx`](./notification.mdx) |
| `globalShortcut` | [`global-shortcut.mdx`](./global-shortcut.mdx) |
| `session.cookies`, cache/storage | [`cache.mdx`](./cache.mdx) |
| `autoUpdater` | [`auto-updater.mdx`](./auto-updater.mdx) |
