...
**Linux 주의**: PDF 인쇄용 `cef_print_handler_t.get_pdf_paper_size`(U.S. Letter) 등록 완료. macOS/Windows 는 네이티브 인쇄라 무영향. 실 PDF 출력 검증은 macOS e2e 러너뿐 — Linux 산출은 CI 빌드까지만(미검증).
