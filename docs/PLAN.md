...
13. 🟡 **자동 업데이트** — manifest check + artifact download + SHA-256 verify + macOS/Linux prepareInstall/quit-and-install 1차 완료. macOS `.zip/.dmg` stage, Linux `.AppImage`/raw 교체 입력, `.deb` package-manager handoff 정책까지 문서화/검증. 남은 것: Windows 적용
